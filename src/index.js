    ...
    return (
        <li className={`pizza ${pizzaObj.soldOut?"sold-out":""}`} >
            ...
            <div>
                ...
                <span> { pizzaObj.soldOut? "SoldOut": pizzaObj.price+3} </span>
            </div>
        </li>
    );
}
...
function Footer(){
    ...
    return(
        ...
        {
            isOpen ? ( <Order closedHour={closedHour} openHour={openHour}/>)
            :
            ( <p>We're happy to welcome you between {openHour}:00 and {closedHour}:00</p>)
        }
        </footer>
    );
}
